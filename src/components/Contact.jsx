  ...
  return (
    <div name='contact' className='w-full h-screen bg-[#0a192f] text-gray-300 flex justify-center items-center p-4'>
      <form method='POST' action="https://getform.io/f/a9b280f8-65ca-43bb-9c51-e4f91b4afb2e" className='flex flex-col max-w-[600px] w-full'>
        <div className='pb-8'>
          <h1 className='text-2xl font-bold border-b-4 border-blue-400 inline'>{language ? 'Contact' : 'Contacto'}</h1>
        ...
        <button className='font-semibold my-8 border-2 border-white px-3 py-1 mx-auto hover:bg-blue-400 hover:border-blue-400'>
